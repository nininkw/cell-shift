...
ActiveRecord::Schema.define(version: 2023_04_19_172618) do
  ...
  create_table "shift_posts", charset: "utf8mb4", force: :cascade do |t|
    t.date "selected_dates"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_shift_posts_on_user_id"
  end
  ...
  add_foreign_key "shift_posts", "users"
